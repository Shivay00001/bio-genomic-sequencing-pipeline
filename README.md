...
Welcome to the **Bio Genomic Sequencing Pipeline** repository. This project is built to deliver a robust and scalable solution tailored to modern development standards.
...
2. Navigate to the project directory:
   ```bash
   cd bio-genomic-sequencing-pipeline
   ```
